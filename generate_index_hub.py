...
MEGAS = [
    ...
    ('ameriques-n',4, {'fr': '🌐 Amér. du Nord',                  'en': '🌐 N. America',                'es': '🌐 Norteamérica',           'de': '🌐 Nordamerika'}),
    ('caraïbes',   5, {'fr': '🌐 Caraïbes',                       'en': '🌐 Caribbean',                 'es': '🌐 Caribe',                 'de': '🌐 Karibik'}),
    ('ameriques-s',6, {'fr': '🌐 Amér. du Sud',                   'en': '🌐 S. America',                'es': '🌐 Sudamérica',             'de': '🌐 Südamerika'}),
    ('oceanie',    7, {'fr': '🌐 Océanie',                        'en': '🌐 Oceania',                   'es': '🌐 Oceanía',                'de': '🌐 Ozeanien'}),
]

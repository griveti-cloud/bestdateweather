...
MEGAS = [
    ...
    ('afrique-mo', 2, {'fr': '🌐 Afrique & Moyen-Orient',        'en': '🌐 Africa & Middle East',      'es': '🌐 África & Oriente Medio',  'de': '🌐 Afrika & Naher Osten'}),
    ('asie',       3, {'fr': '🌐 Asie',                           'en': '🌐 Asia',                      'es': '🌐 Asia',                   'de': '🌐 Asien'}),
    ('ameriques',  4, {'fr': '🌐 Amériques',                      'en': '🌐 Americas',                  'es': '🌐 Américas',               'de': '🌐 Amerika'}),
    ('oceanie',    5, {'fr': '🌐 Océanie & Outre-mer',            'en': '🌐 Oceania & Overseas',        'es': '🌐 Oceanía & Ultramar',     'de': '🌐 Ozeanien & Überseegebiete'}),
]
...
SUB_NAMES = {
    ...
    'Pacifique & Outre-mer':        {'fr': 'Pacifique & Outre-mer',        'en': 'Pacific & Overseas',              'es': 'Pacífico y Ultramar',          'de': 'Pazifik & Überseegebiete'},
}
            ...
            for sub_name, dests in sorted_subs:
                ...
                for d in sorted(dests, key=lambda x: x['nom_bare']):
                    ...
                    if is_fr:
                        ...
                        card_country = d.get('country_es') or d['pays']
                    elif lang == 'de':
                        card_country = d.get('country_de') or d['pays']
                    else:
                        card_country = d.get('country_en') or d['pays']
                    L.append(make_card(slug, name, d['nom_bare'], d['flag'], card_country, asset_prefix, page_prefix, loc))

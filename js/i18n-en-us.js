// BestDateWeather — i18n-en-us.js (English US locale)
// Differs from i18n-en.js: dateLocale, dateFormat, datePlaceholder, defaultUnits
window.BDW_T = {
 // Placeholders
 ...
 checkWeather: 'Check the weather',
  ...
  hist_tmin: 'Daily min',
  wowExample: 'e.g. Bali → best in July (8.2/10) · Monaco → August (9.4/10)',
 ...
 snowDepthLabel: 'Snow depth', snowDepthPoor: 'Poor', snowDepthOk: 'Fair', snowDepthGood: 'Good', snowDepthExcellent: 'Excellent',
 ...
 scPoor: 'Unfavourable', scBad: 'Challenging climate',
 ...
 actBookOk: 'Stable weather',
 actResidual: ' (minor risk)',
 ...
 chipWind: 'Wind', chipSnow: 'Snow', chipHumidity: 'Humidity',
  chipRessenti: '🌡 Feels like',
 dewHumid: '💦 Humid', dewVeryHumid: '💦 Very humid', dewSuffocating: '💦 Oppressive', ressentiFroid: 'Cold', ressentiFrais: 'Fresh', ressentiConfortable: 'Comfortable', ressentiLourd: 'Oppressive', ressentiHumide: 'Humid heat', ressentiTresChaud: 'Very hot',
 spreadStable: '🌡 Stable', spreadVariable: '🌡 Variable',
 forecast7dLabel: '7-day forecast', dayToday: 'Today',

...
function geocode(city) {
 ...
 var _gl=document.documentElement.lang||'fr'; if(_gl==='en-us')_gl='en'; if(_gl!=='en'&&_gl!=='es'&&_gl!=='de')_gl='fr'; return fetch('https://geocoding-api.open-meteo.com/v1/search?name=' + encodeURIComponent(clean) + '&count=5&language='+_gl)
...
function fetchAC(q){
 ...
 if(hint) hint.style.display='none';
 var _gl2=document.documentElement.lang||'fr'; if(_gl2==='en-us')_gl2='en'; if(_gl2!=='en'&&_gl2!=='es'&&_gl2!=='de')_gl2='fr';

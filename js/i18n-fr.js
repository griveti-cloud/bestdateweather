// BestDateWeather — i18n-fr.js (French locale)
window.BDW_T = {
 // Placeholders
 ...
 partlyCloudy: 'Éclaircies', sunny: 'Ensoleillé', hotWave: 'Caniculaire', lightSnow: 'Neige légère',

 // Moon phases
 moonNew: 'Nouvelle lune', moonWaxCrescent: 'Croissant montant',
 ...
 chipWind: 'Vent', chipSnow: 'Neige', chipHumidity: 'Humidité',
  chipRessenti: '🌡 Ressenti',
 dewHumid: '💦 Humide', dewVeryHumid: '💦 Très humide', dewSuffocating: '💦 Étouffant', ressentiFroid: 'Froid', ressentiFrais: 'Frais', ressentiConfortable: 'Confortable', ressentiLourd: 'Lourd', ressentiHumide: 'Chaleur humide', ressentiTresChaud: 'Très chaud',
 ...
 chip_hotel: 'Hébergements', chip_activ: 'Activités', chip_flight: 'Vols',
...
window.BDW_CFG = {
 ...
 'athènes':'athens','mykonos':'mykonos','santorin':'santorini','rhodes':'rhodes',
 ...
 'cancún':'cancun','cancun':'cancun','barbade':'barbados','maldives':'maldives',
 'île maurice':'mauritius','maurice':'mauritius','zanzibar':'zanzibar',
 'dubaï':'dubai','dubai':'dubai','goa':'goa','phuket':'phuket','bali':'bali',
 ...
 'cayenne':'cayenne','remire':'cayenne','remire-montjoly':'cayenne','kourou':'cayenne',
 'fort-de-france':'martinique','martinique':'martinique','le lamentin':'martinique',
 'pointe-a-pitre':'guadeloupe','guadeloupe':'guadeloupe','basse-terre':'guadeloupe',
 'saint-denis':'reunion','la reunion':'reunion','reunion':'reunion',
 'mamoudzou':'mayotte','mayotte':'mayotte',
 'noumea':'noumea','nouvelle-caledonie':'noumea',
 'papeete':'papeete','tahiti':'papeete','polynesie':'papeete'
},
 seaClimData: {
 ...
 'cayenne':[27,27,27,27,27,27,27,27,27,28,28,27],
 'martinique':[27,27,27,27,28,28,29,29,29,28,28,27],
 'guadeloupe':[27,27,27,27,28,28,29,29,29,28,28,27],
 'reunion':[27,27,27,26,25,23,22,22,23,24,26,27],
 'mayotte':[28,28,28,28,27,26,25,24,25,26,27,28],
 'noumea':[27,27,26,25,24,23,22,22,22,23,24,26],
 'papeete':[29,29,29,29,28,27,27,27,27,27,28,28]
},
 ...
 countryShort: {},
 countryFull: {
 'GP':'Guadeloupe','MQ':'Martinique','RE':'La Réunion','GF':'Guyane',

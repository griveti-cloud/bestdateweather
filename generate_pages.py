...
CORE_JS_VERSION = 29
APP_CSS_VERSION  = 11   # Bumper ici force le rechargement du cache CSS (app.css?v=N)
...
<script src="{pfx}js/dest-search.js?v=4"></script>
<script>
...
<script src="{C['asset_prefix']}js/dest-search.js?v=4"></script>
<script>

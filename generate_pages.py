...
<a href="{flights_url}" target="_blank" rel="sponsored noopener" class="plan-link plan-link-flight">{_pb_flight_lbl}</a>
 ...
 <div class="flex-wrap-14">{"".join(pillar_comp_cards)}</div>
    ...
    article_schema = json.dumps({
        ...
        "author": {"@type": "Organization", "name": "BestDateWeather", "url": "https://bestdateweather.com/a-propos.html"},
        "publisher": {"@type": "Organization", "name": "BestDateWeather", "url": "https://bestdateweather.com/a-propos.html"},

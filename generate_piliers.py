...
.filter-panel{background:var(--cream);border:1.5px solid var(--cream2);border-radius:14px;padding:14px 16px;margin-bottom:24px;display:flex;flex-direction:column;gap:0}.filter-row{display:flex;flex-direction:column;gap:8px;padding:12px 0;border-bottom:1px solid var(--cream2)}.filter-row:last-child{border-bottom:none;padding-bottom:2px}.filter-label{font-size:10px;font-weight:700;color:var(--slate);letter-spacing:.08em;text-transform:uppercase}.filter-btns{display:flex;gap:6px;flex-wrap:wrap;align-items:center}.month-nav{display:flex;gap:6px;flex-wrap:wrap;align-items:center}.month-nav a{padding:6px 10px;border-radius:8px;font-size:12px;font-weight:600;text-decoration:none;background:white;border:1.5px solid var(--cream2);color:var(--navy);white-space:nowrap;flex-shrink:0}.month-nav a.active{background:var(--gold);color:white;border-color:var(--gold)}.month-nav a:hover{border-color:var(--gold)}

...
def generate_page(mi, lang, dests, climate, country_info=None):
    ...
    bl = pil.get('budget_labels', {'1':'💚 Économique','2':'💚 Abordable','3':'🟡 Intermédiaire','4':'🟠 Haut de gamme','5':'💎 Premium'})
...
def generate_annual_page(lang, dests, climate, country_info=None):
    ...
    _bl = pil.get('budget_labels', {'1':'💚 Économique','2':'💚 Abordable','3':'🟡 Intermédiaire','4':'🟠 Haut de gamme','5':'💎 Premium'})
